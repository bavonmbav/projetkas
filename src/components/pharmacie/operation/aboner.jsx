...
const VenteProduitaboner = () => {
  const [clientType, setClientType] = useState('abonne');
  const [clientId, setClientId] = useState('A1');
  const [clientName, setClientName] = useState('gabriel');
  const [clientAddress, setClientAddress] = useState('likasi');
...
export default VenteProduitaboner;
